        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary roleIdClass" onclick="agregarRoles('<?php echo $user->id; ?>');" disabled>Agregar</button>
    ...
    <script>
        function CargarRolesEmpresas() {
            ...
            $("#roles").change(function() {
                let roleActivo = $("#roles option:selected").val();

                if (roleActivo !== "-1") {
                    $(".roleIdClass").removeAttr("disabled");
                }
            });
        ...
        function addOptions(domElement, json, sgroup) {
            ...
            option = '<option value="-1" disabled selected>-Seleccione Grupos BPM-</option>';
            $('#roles').append(option);
